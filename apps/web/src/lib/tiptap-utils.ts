...
export function findNodePosition(props: {
  ...
  if (hasValidPos) {
    // biome-ignore lint/style/noNonNullAssertion: generated code, guarded by hasValidPos
...
const ATTR_WHITESPACE =
  // biome-ignore lint/suspicious/noControlCharactersInRegex: intentional whitespace matching
  /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g;
