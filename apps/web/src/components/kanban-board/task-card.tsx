      ...
      <ContextMenu>
        <ContextMenuTrigger asChild>
          ...
          <div
            ...
            className={`group relative cursor-move rounded-lg border bg-card p-3 shadow-sm dark:shadow-[0_2px_10px_rgba(0,0,0,0.45)] transition-all duration-150 [transition-timing-function:cubic-bezier(0.25,1,0.5,1)] motion-reduce:transition-none ${
              isDragging
                ? "border-ring/40 shadow-xl dark:shadow-[0_8px_24px_rgba(0,0,0,0.6)]"
                : "hover:border-border/90 hover:bg-[color-mix(in_srgb,var(--color-card)_91%,white)] dark:hover:bg-[color-mix(in_srgb,var(--color-card)_91%,white)]"
            } ${
              isTaskSelected
