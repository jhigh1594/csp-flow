      ...
      <div className="flex gap-3 p-3 h-full min-w-max transition-all duration-200 ease-out">
        {columns.map((column) => {
          return (
            ...
            >
              <div className="flex flex-col h-full w-full min-h-0 backdrop-blur-xs rounded-lg bg-card border border-border/50 transition-all duration-300 ease-out hover:bg-accent/20 hover:shadow-sm">
