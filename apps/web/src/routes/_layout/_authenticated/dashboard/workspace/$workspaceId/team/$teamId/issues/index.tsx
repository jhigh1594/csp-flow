...
function RouteComponent() {
  ...
  const { project: storeProject, setProject } = useProjectStore();
  ...
  const adapted = useMemo(
    () => buildTeamBoard(teamId, workspaceId, typedColumns, typedIssues),
    [teamId, workspaceId, typedColumns, typedIssues],
  );
      ...
      <Layout.Content>
        ...
        <div className="relative flex flex-col h-full min-h-0 overflow-hidden">
          {isLoading ? (
            ...
            <KanbanBoard project={boardProject} teamId={teamId} />
          ) : (
            <ListView
              issues={typedIssues}
              workspaceId={workspaceId}
